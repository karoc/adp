...
PACKAGE_NAME="adp-0.1.0-artifact-smoke"
...
info "building artifact-smoke release artifacts with release ldflags"
...
assert_contains "$output" "adp version $VERSION" "artifact-smoke version output"
assert_contains "$output" "commit: $COMMIT" "artifact-smoke version output"
assert_contains "$output" "built: $BUILD_DATE" "artifact-smoke version output"
