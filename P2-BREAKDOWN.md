...
> **状态更新（2026-06-27）：已归档。** 本文档是 P2 阶段实施前的任务拆解草案。
> `adp quickstart`、非交互模式、ID 前缀匹配、会话/任务相关补全和聚合门禁已在后续阶段落地并纳入测试。
> 当前 ADP 账本无剩余 planned/ready/in-progress/blocked 任务；文末未勾选验收项是历史草案格式，
> 不代表当前待办。
