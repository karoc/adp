...
- P3/P4/P5/P6/P7/P8/P9/P10/P11 non-goals: no Web dashboard, SaaS tracker, cloud sync, hosted orchestration, automatic Git execution, automatic task closure, provider-native conversation resume, remote issue-service integration, project-root report exports, or hosted tracker semantics.
