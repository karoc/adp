...
> **状态更新（2026-06-27）：已归档。** 本文档记录的是 2026-06-13 P0-P2
> 验证后的临时后续计划。当前 ADP 账本显示 `adp` workspace 无剩余 planned/ready/in-progress/blocked
> 任务，且后续 P24-P65、v1.0.0 发布和 2026-06-27 Windows 可移植性修复已经覆盖这些事项。
> 下方“待执行/进行中”状态是历史快照，不代表当前待办。
